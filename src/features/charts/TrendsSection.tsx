    ...
    <div className="mt-8 grid gap-4 lg:grid-cols-3">
      {[0, 1, 2, 3].map((item) => (
        <Card
          key={item}
          className={
            item === 1 || item === 3 ? 'lg:col-span-3' : item === 2 ? 'lg:col-span-2' : undefined
          }
        >
    ...
    <section id="tendencias" aria-label="Tendencias" className="scroll-mt-24 py-12">
      <div className="reveal flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-tight">Cómo va la temporada</h2>
          <p className="mt-1 text-sm text-muted-foreground">Ventas {PERIOD_LABELS[period]}</p>
        </div>
        <Tabs
          value={period}
      ...
      <div ref={gridRef} className="mt-8 grid gap-4 lg:grid-cols-3">
        ...
        <ChartCard title="Por región" description="Desglose del periodo" className="lg:col-span-3">
